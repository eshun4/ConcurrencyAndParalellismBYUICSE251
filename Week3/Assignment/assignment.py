...
if __name__ == '__main__':
    ...
    total_list=[(rf'elephant/image{image_number:03d}.png',rf'green/image{image_number:03d}.png',rf'processed/image{image_number:03d}.png') for image_number in range(1,301)]
    xaxis_cores=[]
    yaxis_times=[]
    for i in range(1,CPU_COUNT+1):
      start = timeit.default_timer()
      with mp.Pool(i) as p:
        p.map(create_new_frame, total_list)
