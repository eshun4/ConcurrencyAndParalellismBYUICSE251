...
def run_with_threads(tur, log, main_turtle):
    ...
    square_circle = threading.Thread(target=draw_circles, args=(tur, lock))
    square_triangles = threading.Thread(target=draw_triangles, args=(tur, lock))
    square_rectangle = threading.Thread(target=draw_rectangles, args=(tur, lock))
    
    all_threads = [square_thread, square_circle,square_triangles, square_rectangle]
